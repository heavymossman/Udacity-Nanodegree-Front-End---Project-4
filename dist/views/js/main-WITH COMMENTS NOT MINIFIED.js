...
function updatePositions() {
    ...
    for (var a = document.body.scrollTop / 1250, b = document.getElementsByClassName("mover"), c = 0; c < b.length; c++) {
        var d = Math.sin(a + c % 5);
        b[c].style.left = b[c].basicLeft + 100 * d + "px"
    }
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noisy", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(a) {
        ...
        function d(a) {
            ...
            for (var b = document.getElementsByClassName("randomPizzaContainer"), c = 0; c < b.length; c++) b[c].style.width = newWidth + "%"
        }
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    ...
    var c = 0;
    console.log("Total number of pizzas: " + c);
    var d = window.innerWidth;
    console.log(d), c = d >= 1200 ? 50 : d >= 992 ? 40 : d >= 768 ? 30 : 10, console.log("Total number of pizzas: " + c);
    for (var e = 0; e < c; e++) {
        var f = document.createElement("img");
        f.className = "mover", f.src = "images/pizza.png", f.style.height = "100px", f.style.width = "73.333px", f.basicLeft = e % a * b, f.style.top = Math.floor(e / a) * b + "px", document.querySelector("#movingPizzas1").appendChild(f)
    }
    updatePositions()
});